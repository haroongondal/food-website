...
<div className="div_Its_now_safe_to">
    ...
    <h1 className="heading_Its_now_safe_to">It's Now Safe To <span className="crave">Crave!</span></h1>
...
<div className="wrap-top-search">
    <div className="search-top-search search-bar" id="searchBar_mid">
       ...
       <button type="submit" className="searchButton-top-search">
         <span className="text-search-link-top-search"><img alt="search-icon" src={searchIcon} style={{width: "25px",height: "25px"}}/></span>
      </button>
    </div>
 </div>
