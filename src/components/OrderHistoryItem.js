            ...
            <div className="section-3-following" style={{display: "flex",marginBottom: "10px",alignItems: "flex-end"}}>
                <div>
                    <div className="button-order-history" style={{margin: "20px 0px"}}>
                        <a href="#abc" style={{backgroundColor: "#E40E0E",color: "white"}}>Re-order<span style={{marginLeft: "33px"}}><img alt="down-arrow" className="image-triangle-arrow" src={triangle}/></span></a>
                    </div>
                    <div className="button-order-history">
                        <a href="#abc" style={{backgroundColor: "#1D1D1D",color: "white"}}>View details<span style={{marginLeft: "10px"}}><img alt="down-arrow"  className="image-triangle-arrow" src={triangle}/></span></a>
                    </div>
                </div>
            </div>
        </div>
